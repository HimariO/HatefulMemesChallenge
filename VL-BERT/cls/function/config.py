...
_C.DATASET.TRAIN_WITH_VAL = False

_C.DATASET.K_FOLD = False
_C.DATASET.K_FOLD_N = -1   # current fold
_C.DATASET.K_FOLD_K = 4   # total fold

_C.DATASET.ANNO_AUG = False   # total fold
...
_C.NETWORK.IMAGE_FROZEN_BACKBONE_ALL = False
...
_C.NETWORK.VLBERT.visual_tag_type = 1

"""
addtional paramter from newer version of transformers
"""
_C.NETWORK.VLBERT.layer_norm_eps = 1e-12
# _C.NETWORK.VLBERT.pad_token_id = 0
_C.NETWORK.VLBERT.output_attentions = False
_C.NETWORK.VLBERT.output_hidden_states = False
_C.NETWORK.VLBERT.is_decoder = False
...
_C.NETWORK.CLASSIFIER_SIGMOID = True
_C.NETWORK.CLASSIFIER_SIGMOID_LOSS_POSITIVE_WEIGHT = 1.0
_C.NETWORK.CLASSIFIER_CLASS = 1
_C.NETWORK.CLASSIFIER_AVG_EMBED = False
...
_C.TRAIN.SWA = False
_C.TRAIN.SWA_START_EPOCH = 5
_C.TRAIN.SWA_EPOCH_PER_CYCLE = 2
_C.TRAIN.SWA_MIN_LR = 6e-8
_C.TRAIN.SWA_MAX_LR = 6e-6
_C.TRAIN.SWA_SCHEDULE = True

_C.TRAIN.ROC_STAR = False
_C.TRAIN.ROC_SAMPLE_SIZE = 512
_C.TRAIN.ROC_START_EPOCH = 2
_C.TRAIN.ROC_INTERLEAVE = False
