...
train_g.add_arg("warmup_steps", float, 0, "Total steps to perform warmup when pretraining.")
...
train_g.add_arg("seed", int, 8487, "Random seed for all random generator.")
train_g.add_arg("balance_cls", bool, False, "Whether to class balanced dataset sampler.")
train_g.add_arg("test_ckpt", str, "", "pytorch lightning checkpoints for inference on test set.")
train_g.add_arg("resume_ckpt", str, None, "pytorch lightning checkpoints for inference on test set.")
train_g.add_arg("fusion_dropout_rate", float, 0.1, "")
train_g.add_arg("accumulate_grad_batches", int, 1, "")
train_g.add_arg("use_aug", bool, True, "Whether to use augmened data during training.")
